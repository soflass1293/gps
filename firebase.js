...
var firebase = function () {
    ...
    return function (t) {
        ...
        e.webpackJsonpFirebase = function (e, o, a) {
            for (var c, s, u, f = 0, h = []; f < e.length; f++) s = e[f], i[s] && h.push(i[s][0]), i[s] = 0;
            for (c in o) Object.prototype.hasOwnProperty.call(o, c) && (t[c] = o[c]);
            for (n && n(e, o, a); h.length;) h.shift()();
            if (a)
        ...
        var f = {
            ...
            h = new i.ErrorFactory("app", "Firebase", f);
        ...
        t.base64 = {
            ...
            encodeByteArray: function (e, t) {
                ...
                for (var r = t ? this._ : this.y, n = [], o = 0; o < e.length; o += 3) {
                    var i = e[o],
                        ...
                        l = (15 & c) << 2 | u >> 6,
                        p = 63 & u;
                    s || (p = 64, a || (l = 64)), n.push(r[f], r[h], r[l], r[p])
                }
                return n.join("")
            },
            ...
            decodeStringToByteArray: function (e, t) {
                ...
                for (var r = t ? this.g : this.b, n = [], o = 0; o < e.length;) {
                    ...
                    var f = o < e.length,
                        h = f ? r[e.charAt(o)] : 64;
                    if (++o, null == i || null == c || null == u || null == h) throw Error();
                    var l = i << 2 | c >> 4;
                    if (n.push(l), 64 != u) {
                        var p = c << 4 & 240 | u >> 2;
                        if (n.push(p), 64 != h) {
        ...
        (function (t) {
            ! function (r) {
                ...
                function i(e) {
                    ...
                    this._state = 0, this._handled = !1, this._value = void 0, this.T = [], h(e, this)
                }
                function a(e, t) {
                ...
                function c(e, t) {
                    try {
                        ...
                        if (t && ("object" == typeof t || "function" == typeof t)) {
                            ...
                            if ("function" == typeof r) return void h(o(r, t), e)
                        }
        ...
        var o = r(72),
            i = function (e) {
                ...
                return n(t, e), t.prototype.reset = function () {
                    ...
                    for (var i, a, c = this.D[0], s = this.D[1], u = this.D[2], f = this.D[3], h = this.D[4], n = 0; n < 80; n++) {
                        n < 40 ? n < 20 ? (i = f ^ s & (u ^ f), a = 1518500249) : (i = s ^ u ^ f, a = 1859775393) : n < 60 ? (i = s & u | f & (s | u), a = 2400959708) : (i = s ^ u ^ f, a = 3395469782);
                        var o = (c << 5 | c >>> 27) + i + h + a + r[n] & 4294967295;
                        h = f, f = u, u = 4294967295 & (s << 30 | s >>> 2), s = c, c = o
                    }
                    this.D[0] = this.D[0] + c & 4294967295, this.D[1] = this.D[1] + s & 4294967295, this.D[2] = this.D[2] + u & 4294967295, this.D[3] = this.D[3] + f & 4294967295, this.D[4] = this.D[4] + h & 4294967295
            ...
            var i, s = r(0),
                ...
                w = function (e) {
                    function t(t) {
                        ...
                        return r.d = null, r.f = Object(s.createSubscribe)(function (e) {
                            r.d = e
                        }), r.h = null, r.p = Object(s.createSubscribe)(function (e) {
                            r.h = e
                        }), r.l(), r
                    }
                    return N(t, e), t.prototype.getToken = function () {
                        var t = this;
                        return this.g() ? this.T().then(function () {
                        ...
                        if (void 0 !== this.b) throw this.e.create(u.codes.USE_SW_BEFORE_GET_TOKEN);
                        this.b = e
                        ...
                        var e = this;
                        return this.b ? this.v(this.b) : (this.b = null, navigator.serviceWorker.register(y.path, {
                            scope: y.scope
                        }).catch(function (t) {
                ...
                A = D,
                P = r(6);
            t.registerMessaging = o, o(P.firebase)
        }
    }, [116])
} catch (e) {
